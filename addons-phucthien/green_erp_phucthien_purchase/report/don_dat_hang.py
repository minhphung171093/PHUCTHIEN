...
class Parser(report_sxw.rml_parse):
    ...
    def _amount_line_tax(self, cr, uid, line, context=None):
        val = 0.0
#         for c in self.pool.get('account.tax').compute_all(cr, uid, line.taxes_id, line.price_unit * (1-(line.discount or 0.0)/100.0), line.product_qty, line.product_id, line.order_id.partner_id)['taxes']:
