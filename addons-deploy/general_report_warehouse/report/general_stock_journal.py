...
class Parser(report_sxw.rml_parse):
    ...
    def get_header(self):
        ...
        self.warehouse = wizard_data['warehouse_id'] and wizard_data['warehouse_id'][1] or ''
        self.warehouse_id  = wizard_data['warehouse_id'] and wizard_data['warehouse_id'][0] or ''
