# Embedded file name: D:\GSProject\GSOpenERP\Ver7x\Server\openerp\addons\gs_mkp_hr_report\wizard\gs_purvey_insurance.py
import netsvc
import time
import pooler
...
class wizard_gs_purvey_insurance(osv.gosv_memory):
